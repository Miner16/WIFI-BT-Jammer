 **Warning! This repo is only for educational purposes!**
 ---
...
`NOT TESTED ON 2.4GHZ DRONES, WORKS THEORETICALLY` 
---
...
* DOWNLOAD AND INSTALL [RF24 LIBRARY](https://github.com/nRF24/RF24)
